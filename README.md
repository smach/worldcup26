...
An R wrapper for the [football-data.org v4
API](https://docs.football-data.org/general/v4/resources.html), focused
on the 2026 FIFA Men’s World Cup. Look up the participating teams, a
team’s full schedule, its next match, or its past results.
